"""
Apply the chosen model to testing image, and create submission
"""
import sys
import urllib
...
def testing(model):
  """
  Apply given model, transfom pixelwise predictions to patchwise ans save csv
  """
